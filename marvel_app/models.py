...
class User(db.Model,UserMixin):
    ...
    #token is used to verify users after giving password/email;
    # allows us to use a site and get info from the back of it
...
class HeroSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name','description', 'comics_appeared_in', 'super_power','date_created', 'user_token']
